      ...
      <div className="container mx-auto mt-32 ml-96">
        <div className="w-1/3 flex flex-col justify-between bg-zinc-800 shadow-md rounded-md p-3">
          ...
          <p className="text-justify">
            Best plan for a month, you can get access for unlimited music, but
            you're account could get banned in less of a month and remember
            we're not giving any warranty.
          </p>
          <button
            className="bg-red-700 text-white mt-5 py-2 rounded-md"
            onClick={() => handleBuy.mutate({ price: 50000 })}
          >
            Buy plan
          </button>
        </div>
